...
getData().then(data => {
  ...
  recovered = data[1];
  deaths = data[2];
  const confirmedCountUp = new _countup.CountUp(document.querySelector('.cassesLabel'), confirmed);
  const deathsCountUp = new _countup.CountUp(document.querySelector('.deathsLabel'), deaths);
  const recoveredCountUp = new _countup.CountUp(document.querySelector('.recoveredLabel'), recovered);
